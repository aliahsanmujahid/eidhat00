    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChangeIds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashOnDelevary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Rocket = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RocketTransactionID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nagad = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NagadTransactionID = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Bikash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rocket = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Namgad = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Desktoppic = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Mobilepic = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Utlites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subsubcateId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HighLights = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<int>(type: "int", nullable: false),
                    DiscPrice = table.Column<int>(type: "int", nullable: false),
                    DisCount = table.Column<int>(type: "int", nullable: false),
                    DeliveryCharge = table.Column<int>(type: "int", nullable: false),
                    Bundel = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubSubMenu", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubSubMenu_SubMenu_SubMenuId",
